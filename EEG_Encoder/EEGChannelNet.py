...
class classifier_EEGChannelNet(nn.Module):
    ...
    Args:
        ...
        '''
    def __init__(self, in_channels=1, temp_channels=10, out_channels=50, num_classes=4, embedding_size=1000,
                 input_width=250, input_height=128, temporal_dilation_list=[(1,1),(1,2),(1,4),(1,8),(1,16)],
