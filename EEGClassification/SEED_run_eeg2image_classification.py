...
from SEED_data_loader_eeg2image import load_data
from SEED_trainer_eeg2image import fit
...
<<<<<<< HEAD
    parser.add_argument('--time-low', type=float, default=40,
                        help='Lowest time value of eeg segment')
    parser.add_argument('--time-high', type=float, default=540,
=======
    parser.add_argument('--time-low', type=float, default=100,
                        help='Lowest time value of eeg segment')
    parser.add_argument('--time-high', type=float, default=700,
>>>>>>> 3f4a57ab802c791057f53f9efa655a7aa1ce6379
